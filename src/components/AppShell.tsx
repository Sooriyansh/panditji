...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  return <SessionProvider><Navbar /><main className="min-h-screen pb-[88px] pt-0 lg:pb-0 lg:pt-24">{children}</main><RatingSection /><SiteFooter /><Chatbot /></SessionProvider>;
}
