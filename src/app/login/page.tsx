...
export default function LoginPage() { return <AuthPage title="अपने अकाउंट में लॉगिन करें" subtitle="बुकिंग और आपकी जानकारी सुरक्षित रूप से देखें।"><AuthForm mode="login" googleEnabled={Boolean(process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET)} /></AuthPage>; }
